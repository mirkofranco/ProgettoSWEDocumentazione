...
gestibili tramite\glossario{Alexa}di \textit{Amazon$_{G}$}. L’obiettivo è la creazione di una\glossario{skill}in grado di avviare\glossario{workflow}creati dagli utenti fornendogli dei \textit{connettori$_{G}$}.
