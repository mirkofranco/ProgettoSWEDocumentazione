...
Dipendenze principali:
\begin{itemize}
	\item \textbf {kotlin-stdlib-jdk7} Libreria standard di\glossario{Kotlin}che si appoggia automaticamente alla versione più aggiornata;
