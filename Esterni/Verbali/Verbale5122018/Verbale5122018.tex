% INSERITO ERRORE IN LINEA 30 E 54 PER TESTARE IL CORRETTORE AUTOMATICO!
...
\begin{titlepage}
	...
	\begin{tabular}{c|c}
		...
		{\hfill\textbf{Distribbuzione}} 			& 			Prof. Tullio Vardanega \\ & Prof. Riccardo Cardin \\ & Gruppo ZeroSeven \\ & Zero12 s.r.l.	\\ %ERRORE DI ORTOGRAFIA "distribbuzione" 
...
\end{titlepage}
	...
	\cleardoublepage
		...
		\begin{tabularx}{\textwidth}{|c|c|X|X|c|}
			...
			\hline
			0.0.1 & 2018-12-08 & Creazione template doccumento //%ERRORE DI ORTOGRAFIA "doccumento" 
	...
	Sì, anche se sviluppare il\glossario{progetto}tramite interfaccia web sarebbe  più semplice poichè basterebbe renderla responsive per averla a disposizione anche nel mobile.
	...
	Inoltre nel blog di\glossario{Amazon}sono presenti degli articoli che suggeriscono come implementare i test in modo  automatico sulle \textit{skill$_{G}$}, facendo attenzione poichè è un ambito abbastanza inesplorato. \\
