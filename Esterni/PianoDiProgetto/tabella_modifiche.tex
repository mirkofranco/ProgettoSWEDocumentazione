	...
	\begin{center}
		\begin{tabularx}{\textwidth}{|c|c|X|X|c|}
			...
			\hline
			1.1.0 & 2019-02-04 & Verifica correzione \ref{accettazione},  \ref{componenti}, \ref{normativi}, \ref{Attualizzazione dei rischi}, \ref{Modello di sviluppo} & Gian Marco Bratzu & Verificatore\\
			\hline
