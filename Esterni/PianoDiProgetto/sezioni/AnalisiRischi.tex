...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
   ...
   \multicolumn{4}{|>{\hsize=\dimexpr4\hsize+4\tabcolsep+\arrayrulewidth\relax}X|}{\textbf{Mitigazione}: Nel caso di forti contrasti, il \textit{Responsabile} cercherà di mediare il dialogo tra i componenti. Inoltre la pianificazione terrà conto di ciò cercando di minimizzare la possibilità che insorgano situazioni di conflitto.}\\
	...
	Ogni membro comunicherà tempestivamente al \textit{Responsabile} gli impegni che possono collidere con le attività di\glossario{progetto}. & Occorrenza: Media. \newline Pericolosità: Media. \\
	\hline
	...
	\hline
	\multicolumn{4}{|>{\hsize=\dimexpr4\hsize+4\tabcolsep+\arrayrulewidth\relax}X|}{\textbf{Mitigazione}: In caso di forte ritardo o grosso sforamento dei costi il \textit{Responsabile} provvederà a ridistribuire il carico mantenendo come obbiettivo primario quello di non sforare le\glossario{milestone}.}\\
	\hline	
