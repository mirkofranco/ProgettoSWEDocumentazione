...
Il prodotto consiste in un'applicazione Android che consentirà all'utente di impostare una \glossario{skill}, questa è composta dai vari \glossario{workflow} che l'utente crea. In ogni workflow sono presenti diversi blocchi per creare la routine. Le funzioni principali del prodotto sono:
\begin{itemize}
