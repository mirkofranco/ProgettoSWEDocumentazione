...
\section{UC2.1.2.4.5: Scrittura tweet}
\label{UC2.1.2.4.5}
\begin{itemize}
	\item \textbf{Attori}: ;
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate} \item 1- L'utente selezione "Calendario - Lettura eventi";  \item  Il blocco è aggiunto al workflow.\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate} \item L'utente seleziona "Calendario - Scrittura eventi";  \item  Il blocco è inserito nel workflow.\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate} \item L'utente seleziona il blocco "News";  \item  L'utente seleziona l'opzione desiderata;  \item  Il blocco è aggiunto al workflow.\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate} \item L'utente seleziona il blocco "Sport";  \item  L'utente seleziona le opzioni desiderate;  \item  Il blocco è inserito nel workflow.\end{enumerate}
\end{itemize}
