...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate} \item L'attore seleziona il blocco Pianificazione; \item L'attore inserisce l'orario; \item L'attore conferma il blocco salvandolo. \end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate} \item L'attore seleziona il blocco; \item  L'attore inserisce il testo; \item L'attore conferma il blocco salvandolo.\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate} \item L'attore seleziona il blocco "Sveglia";  \item  L'attore seleziona l'orario;  \item  L'attore seleziona quale tipo di suono riprodurre; \item L'attore conferma il blocco salvandolo. \end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate}  \item  Il sistema avvisa l'utente dell'inesistenza dell'url;  \item  L'utente modifica l'url o lo elimina.\end{enumerate}
\end{itemize}
