...
\subsubsection{Blocco TwitterHashtag} \label{twitter}
...
\begin{enumerate}
	...
	\item Inserire la parola chiave di ricerca preceduta dal simbolo "#" (hashtag) e successivamente cliccare sul tasto conferma;
\end{enumerate}
