...
Se Alexa dice di dover effettuare la configurazione con l'account Amazon bisogna seguire le instruzioni indicate nella  sezione precedente "configurazione Skill MegAlexa". Altrimenti  si può procedere con esecuzione dei workflow a disposizione 
...
\begin{itemize}
	...
	\begin{itemize}
       ...
       \texttt{A: Vuoi aggiungere un altro elemento?}
		...
		\texttt{A: [elemento]x5, vuoi sentirne altri oppure vuoi modificare o eliminare uno di questi? }\\
		\textit{U: [No Intent]}\\
		\texttt{A: Va bene | Ok}\end{comment}
