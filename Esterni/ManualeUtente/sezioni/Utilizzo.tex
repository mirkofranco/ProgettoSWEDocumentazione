...
\end{enumerate}
\newpage
\item  \textbf{Esecuzione skill MegAlexa}\\
\label{Esecuzione skill}
...
nelle conversazioni che presentiamo molte delle frasi che Alexa andrà a dire costituiranno un blocco di testo,cioè un pezzo di testo che l'utente andrà a inserire prima dell'esecuzione un blocco.
