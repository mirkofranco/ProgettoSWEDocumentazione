...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		...
		\caption{Blocco ascolto tweets di un altro user}
	\end{figure}
\end{enumerate}
...
\begin{enumerate}
	...
	\item Nella pagina web che comparirà:
		\begin{enumerate}
			...
			\item Cliccare sul tasto "Authorize app".
		\end{enumerate}
	\begin{figure}[!ht]
		\centering
...
\begin{enumerate}
	\item Una volta creato il workflow con i blocchi, clicchiamo sul pulsante in alto a destra della schermata per salvare il tutto;
\end{enumerate}
