...
\end{figure}
\end{comment}
\textbf{NOTA BENE:} le operazioni di rimozione e modifica dell'ordine, descritte nei prossimi punti, sono permesse solo dopo l'aggiunta di elementi alla lista tramite Alexa.
\begin{itemize}
	...
	\begin{figure}[!ht]
	\centering
	\fbox{\includegraphics[scale=0.2]{images/DeleteItem.jpg}}
	...
	\begin{enumerate}
		...
		\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/ShiftItem.jpg}}
		\caption{Modifica ordine elementi nella lista}
		\end{figure}
		\end{comment}
	\end{enumerate}
\end{itemize}
