...
\item Cliccare sul tasto "+" per aggiungere un nuovo workflow.
	...
	\end{figure}
	\newpage
\item Ora bisogna dare un nome al workflow.\\
...
\begin{enumerate}
	...
	\item Premere l'icona in alto a destra per confermare e salvare.\\

	\begin{figure}[!ht]
		\fbox{\includegraphics[scale=0.2]{images/AddWorkflow.jpg}}
		\qquad\qquad
		\fbox{\includegraphics[scale=0.2]{images/InsertName.jpg}}
...
\end{enumerate}
\newpage
Nell'elenco dei workflow, a questo punto, si potrà vedere il nuovo workflow appena creato.

\begin{figure}[!ht]
	\centering
	\fbox{\includegraphics[scale=0.2]{images/HomeWorkflow.jpg}}
	\caption{Elenco workflow}
\end{figure}
\newpage
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.4]{images/BlockPIN.jpg}}
		\caption{Blocco PIN}
	\end{figure}
	\end{comment}
\end{enumerate}
...
Con questo blocco l'utente avrà la possibilità di inviare le email con Gmail tramite app.
...
Per sapere quali blocchi contiene il nostro workflow, andare nella schermata che mostra l'elenco di tutti i workflow disponibili e cliccare sul nome di quello che ci interessa.
In questo modo verrà visualizzato l'elenco dei blocchi al suo interno come mostrato in figura:
\begin{figure}[!ht]
	\fbox{\includegraphics[scale=0.2]{images/HomeWorkflow2.jpg}}
	\qquad
	\fbox{\includegraphics[scale=0.2]{images/BlocksWorkflow.jpg}}
	\caption{Blocchi del workflow}
\end{figure}
\newpage
\section{Utilizzo di Alexa}
Alexa è un assistente personale intelligente sviluppato dall'azienda statunitense Amazon, utilizzato per la prima volta nei dispositivi Amazon Echo e Amazon Echo Dot.
Alexa  consente all'utente di fare delle domande e delle richieste usando semplicemente la voce.\\
