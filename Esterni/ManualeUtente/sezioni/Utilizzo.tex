...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockPIN.jpg}}
		\caption{Blocco PIN}
	\end{figure}
\end{enumerate}
\newpage
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockFilter3.jpg}}
		\caption{Blocco News}
	\end{figure}
\end{enumerate}
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockStock.jpg}}
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockTwitter2.jpg}}
		\caption{Blocchi Twitter disponibili}
	\end{figure}
	\newpage
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockTwitterUser.jpg}}
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockTwitter3.jpg}}
		\caption{Blocchi Twitter disponibili}
	\end{figure}
	\newpage
	\item Accedere con il proprio account Twitter cliccando sul tasto
		...
		\begin{figure}[!ht]
			\centering
			\fbox{\includegraphics[scale=0.2]{images/BlockTwitterHome.jpg}}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/AuthorizationTwitter.jpg}}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockTwitterHome2.jpg}}
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockTwitter4.jpg}}
		\caption{Blocchi Twitter disponibili}
	\end{figure}
	\newpage
	\item Accedere con il proprio account Twitter cliccando sul tasto
		...
		\begin{figure}[!ht]
			\centering
			\fbox{\includegraphics[scale=0.2]{images/BlockTwitterWrite.jpg}}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/BlockTwitterWrite2.jpg}}
		\caption{Blocco scrittura tweet su Twitter}
	\end{figure}
\end{enumerate}
...
Una volta inseriti tutti i blocchi, clicchiamo sul pulsante in alto a destra della schermata per salvare e creare il workflow.
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/SaveWorkflow.jpg}}\quad\quad
		\fbox{\includegraphics[scale=0.2]{images/HomeWorkflow.jpg}}
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/ShiftBlock2.jpg}}
...
\begin{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/DeleteBlock.jpg}}
	...
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/DeleteBlockWindow.jpg}}
		\caption{Finestra di conferma cancellazione}
	\end{figure}
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/DeleteBlockResult.jpg}}
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{figure}[!ht]
			\centering
			\fbox{\includegraphics[scale=0.2]{images/ChangeName.jpg}}
			\caption{Finestra inserimento nuovo nome}
		\end{figure}
	\end{enumerate}
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/ChangeNameResult.jpg}}
		\caption{Workflow con nuovo nome}
	\end{figure}
\end{enumerate}

\subsection{Eliminare un workflow}
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{figure}[!ht]
			\centering
			\fbox{\includegraphics[scale=0.2]{images/DeleteWorkflowWindow.jpg}}
			\caption{Finestra conferma eliminazione}
		\end{figure}
	\end{enumerate}
	\begin{figure}[!ht]
		\centering
		\fbox{\includegraphics[scale=0.2]{images/HomeWorkflowEmpty.jpg}}
