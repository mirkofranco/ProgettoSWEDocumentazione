...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Range di ottimalita'}: >= 0 giorni.
	\end{itemize}
	\item \textbf{MP002}: Cost Variance
	\begin{itemize}
		\item \textbf{Range di accettazione}: >= -4;
		\item \textbf{Range di ottimalita'}: >= 0.
	\end{itemize}
\end{itemize}
