...
\hline
\endhead
\hypertarget{TU1}{TU1} & Viene controllato che ritorni un testo & Lambda::blocks::TextToSpeechBlock::text() & \textit{Implementato}\\ \hline
...
\hline
\endhead
\hypertarget{TU1}{TU1} &  & \textit{Implementato}\\ \hline
\caption[Test di Unità]{Test di Unità}
\label{tabella:test2}
\end{longtable}
\clearpage