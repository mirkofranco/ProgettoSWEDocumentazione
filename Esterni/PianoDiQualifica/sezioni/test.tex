...
TUA11 & Viene controllato che l'account di Google sia valido per il Calendar & \textit{Implementato}\\ \hline
TUA12 & Viene controllato che l'account di Google Mail sia valido per la lettura delle email & \textit{Implementato}\\ \hline
TUA13 & Viene controllato che il numero di telefono sia associato ad un account Telegram & \textit{Non implementato}\\ \hline
TUA14 & Viene controllato che l'account Twitter dell'utente sai valido & \textit{Implementato}\\ \hline
