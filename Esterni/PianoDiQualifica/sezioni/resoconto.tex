...
\begin{figure} [h]
    ...
    \caption{\textit{MP015 - MP015 Differenza soddisfatti e non soddisfatti}}
\end{figure}
...
\subsection{MPR002 \textbf{Indice di Gulpease$_{G}$}}
\begin{figure} [h]
    \centering
	\includegraphics[scale=0.5]{./images/gulpeaseP.png}
    \caption{\textit{MPR002 \glossario{Indice di Gulpease}}}
\end{figure}
\newpage
