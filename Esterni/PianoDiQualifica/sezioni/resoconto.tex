...
\textbf{Passato}\\
\textbf{tempo medio per risolvere un errore: 35 minuti.}\\
...
\subsection{MP015, MP016: Percentuale requisiti soddisfatti}
\textbf{Passato}\\
Sono stati soddisfatti tutti i requisiti che il gruppo aveva preventivato, con l'eccezione del requisito riguardante la sveglia, che attualmente non era possibile implementare con le API fornite da Alexa Skill Kit (dopo una riunione con la proponente, e con la sua approvazione,  questo requisito è stato rimosso).
...
\begin{figure} [h]
    \centering
	\includegraphics[scale=0.5]{./images/rodPDC.png}
    \caption{\textit{MP015 - MP016 Tipologia di requisiti - Progettazione di dettaglio e codifica}}
\end{figure}
\begin{figure} [h]
    \centering
	\includegraphics[scale=0.5]{./images/parsodPDC.png}
