...
\subsection{MP007 MP008 MP009 MP010 MP011 }
\textbf{Passato}\\
I seguenti grafici descrivono la manuntenibilità del codice, calcolata da SonarCloud usando le metriche riportate nel titolo.\\
\begin{itemize}
...
\begin{figure} [H]
    ...
    \caption{\textit{MP007 MP008 MP009 MP010 MP011 - manuntenibilità del codice app Android - Validazione e Collaudo}}\label{}
\end{figure}
\begin{figure} [H]
    \centering
...
Vale quando detto nel periodo precedente, cioè la risuluzione dei problemi nella skill rimane qualcosa di costoso e poco efficente da eseguire. Questo perché, per risolvere i problemi che non vengono segnalati dai test di integrazione e unità, è necessario il rilascio della skill in AWS Lambda.\\
