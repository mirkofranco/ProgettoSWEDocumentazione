...
\begin{itemize}
	...
	\subitem Assegnazione di compiti per lo svolgimento delle \glossario{attivita'};
...
\begin{enumerate}
	...
	Il \glossario{Verificatore} dovrà quindi effettuare un ulteriore controllo allo scopo di constatare che l’output finale sia conforme a quanto precisato nelle \textit{Norme di Progetto v1.0.0};
	\item \textbf{Calcolo dell'indice di Gulpease:} Utilizzando gli strumenti automatici definiti nelle \textit{Norme di Progetto v1.0.0}, su ogni documento redatto il \\ \glossario{Verificatore} deve calcolare l’indice di leggibilità.
