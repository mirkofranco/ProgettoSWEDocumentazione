...
\begin{itemize}
	\item MPR000 Completezza dell'implementazione funzionale
	\item MPR000 Correttezza rispetto alle attese;
\end{itemize}
...
\begin{itemize}
	\item MPR000 Totalità di failure.
\end{itemize}
...
\begin{itemize}
	...
	Le metriche utilizzate per la valutazione, definite nelle Norme di progetto in ??, sono le seguenti:
	\begin{itemize}
		\item MPR000 Comprensibilità delle funzioni offerte;
		\item MPR000 Facilità di apprendimento;
	\end{itemize}
...
\begin{itemize}
	\item MPR000 Capacità di analisi failure;
	\item MPR000 Impatto delle modifiche
\end{itemize}
