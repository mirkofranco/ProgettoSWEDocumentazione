...
\begin{itemize}
	\item \textbf{Effficacia funzionale:} Indice che determina il grado di copertura di bisogni e obiettivi richiesti dall'utente;
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Protezione dall'errore:} Rappresenta il grado in cui il\glossario{prodotto}protegge l'utente dal commettere errori;
...
\begin{itemize}
	\item \textbf{Confidenzialità:} percentuale per la quale l'applicazione assicura che i dati siano accessibili solo da utenti autorizzati. E' importante notare che l'\textit{Alexa$_{G}$} di\glossario{Amazon}è uno speaker, pertanto l'output prodotto è accessibile a chiunque nella stanza;
...
Con manutenibilità intendiamo la capacità del\glossario{prodotto}di essere modificato tramite correzioni, miglioramenti e adattamenti.
