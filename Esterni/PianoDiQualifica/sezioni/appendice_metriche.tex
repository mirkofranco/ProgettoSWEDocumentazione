...
\begin{itemize}
	...
	\item \textbf{Recuperabilità:} Nel caso in cui si presentano errori, dovuti a uno scorretto comando da parte dell'utente, l'echo riesce a recuperare l'esecuzione del workflow nel punto dove è stato interrotto.
\end{itemize}
