...
\begin{document}
	...
	\begin{table}[tbph]
		...
		\begin{tabularx}{\textwidth}{|C|C|}
			...
			\hline
			01-VER\_2019-02-01& Inserire i casi d'uso e i requisiti su \glossario{PragmaDB}\\
			\hline
		    02-VER\_2019-02-01& \glossario{Express} versione 4.16.4: framework utilizzato per NodeJS\\
		    \hline
		    03-VER\_2019-02-01& \glossario{Jasmine} versione 3.0.0: strumento utilizzato per effettuare i test per il codice in NodeJS\\
			\hline
			04-VER\_2019-02-01& \glossario{NPM} versione 6.4.1: strumento utilizzato per la gestione della build del codice prodotto \\
			\hline
			05-VER\_2019-02-01& \glossario{AWS Lambda}: strumento utilizzato per l'esecuzione del codice nel server\\
			\hline
			06-VER\_2019-02-01& \glossario{DynamoDB}: strumento utilizzato come database NoSQL\\
			\hline
			07-VER\_2019-02-01& \glossario{API Gateway}: \glossario{REST API} offerta da Amazon\\
			\hline
		\end{tabularx}
