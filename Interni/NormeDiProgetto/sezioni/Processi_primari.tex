...
\begin{itemize}
	\item  \textbf{com.megalexa.activities:} conterrà tutti file contententi le \glossario{activities} dell'applicazione.
	...
	\item  \textbf{com.megalexa.fragments} conterranno i file riguardanti i \glossario{fragments} prodotti dalle activities;
	\item  \textbf{com.megalexa.viewModels}	conterranno tutti i file che compongono il \glossario{ViewModel}, che mette in comunicazione la parte grafica con quella logica;	
...
Sfruttare il comando fornito da javadoc per fornire una descrzione accurata delle funzioni che vengono implementate.\\
...
La \glossario{schema} adottato da Kotlin per definire i layout in XML permette di definire id univoci nel seguente modo: 
