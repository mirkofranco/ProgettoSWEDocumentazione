...
\begin{itemize}
	...
	\item  \textbf{com.megalexa.util:} contiene tutte la classi di utilità definite nel corso dello sviluppo.
		\subitem	\textbf{service:} contiene i file che realizzano l'integrazione ad \textit{API Gateway$_{G}$} effetuando le chiamate necessarie;
		\subitem	\textbf{view:} contiene interfacce utili per la realizzazione di interazioni particolari tra l'utente e l'interfaccia grafica.	
