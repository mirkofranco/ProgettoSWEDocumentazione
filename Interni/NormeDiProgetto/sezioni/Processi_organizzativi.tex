...
Le decisioni prese durante gli incontri devono essere identificate con un codice univoco per permettere di riferirsi ad esse se necessario, per ciò nei verbali sarà presente il tracciamento delle decisioni nel quale verrà associato ad ogni decisione un identificativo che segue questa codifica:
\begin{center}
