...
\subsection{MP005: SPICE capability level}
...
\subsection{MP009: Complessità ciclomatica}
...
\subsection{MP013: Linee di codice per commento}
...
\subsection{MP017: Copertura del codice}
...
\subsection{MP020:Errori risolti tramite test}
...
\end{center}
\subsection{MP021:Percentuale build superate}
...
\subsection{MP022:Media commit per settimana}
\begin{center}
	$\frac{\mbox{commit totali}}{\mbox{totale settimane di lavoro}}$
\end{center}


\subsection{MP023:Percentuale requisiti obbligatori soddisfatti}
...
\subsection{MP024:Percentuale requisiti desiderabili soddisfatti}
Tale metrica è risultato del seguente calcolo:
\begin{center}
