...
\section{Validazione}
\subsection{Test}
\'E compito dei \textit{Progettisti} definire i test nel periodo di progettazione; vengono fornite indicazioni specifiche sulla coretta codifica dei test e la loro natura, suddividendo per tecnologie adottate qualora le differenze richiedano un dettaglio maggiore.\\
