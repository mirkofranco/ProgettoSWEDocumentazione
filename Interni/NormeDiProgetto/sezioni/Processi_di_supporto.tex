...
Gli obiettivi di qualità inclusi nel \textit{Piano di Qualifica v1.0.0} devono rispettare la seguente notazione: \\
\begin{center}
Q[Tipo][ID] : [Nome].
\end{center}
\begin{itemize}
...
ì
\section{Validazione}
Il processo di \glossary{validazione} permette di accertare la conformità del prodotto rispetto a quanto è stato pianificato.\\
