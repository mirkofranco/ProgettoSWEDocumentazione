...
Lo scopo del progetto è lo sviluppo di un applicativo Web e Mobile in grado di creare delle routine personalizzate per gli utenti gestibili tramite\glossario{Alexa}di \textit{Amazon$_{G}$}. L'obiettivo è la creazione di una\glossario{skill}in grado di avviare\glossario{workflow}creati dagli utenti fornendogli dei \textit{connettori$_{G}$}.
...
documento \textit{Glossario v3.0.0}, al fine di evitare ogni ambiguità di linguaggio
