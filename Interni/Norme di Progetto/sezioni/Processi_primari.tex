...
\end{itemize}
Come da \textit{Piano di Progetto v1.0.0} la Progettazione si svolgerà nell'arco di due periodi distinti, duranti i quali verranno prodotti rispettivamente i documenti Specifica Tecnica e Definizione di Prodotto.
