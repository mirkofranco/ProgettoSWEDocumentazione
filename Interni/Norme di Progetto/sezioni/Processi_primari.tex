...
\begin{itemize}
	...
	\item \textbf{Finalitià del progetto};
...
\end{itemize}
Come da \textit{Piano di Progetto v1.0.0} la Progettazione si svolgerà nell'arco di due periodi distinti, duranti i quali verranno prodotti rispettivamente i documenti \textit{Specifica Tecnica} e \textit{Definizione di Prodotto}.
