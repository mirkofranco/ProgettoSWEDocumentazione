...
\begin{itemize}
	\item \textbf{Qualità di processo}: per garantire la qualità dei processi attraverso l'utilizzo di strumenti e metriche, inoltre è necessario adottare come standard ISO/IEC 15504.
	\item \textbf{Qualità di prodotto}: per garantire e misurare la qualità dei prodotti sviluppati, è necessario adottare come standard ISO/IEC 15010.
\end{itemize}
