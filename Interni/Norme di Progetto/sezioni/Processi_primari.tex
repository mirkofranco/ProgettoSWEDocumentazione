...
\begin{itemize}
	\item \textbf{Controllo di qualità di processo} per garantire la qualità dei processi attraverso l'utilizzo di strumenti e metriche;
	\item \textbf{Controllo di qualità di prodotto} ;
