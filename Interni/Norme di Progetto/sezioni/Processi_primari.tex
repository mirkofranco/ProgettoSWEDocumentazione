...
\paragraph{Strumenti}
Di seguito vengono elencati gli strumenti utilizzati durante lo svolgimento del\glossario{progetto}:

\subparagraph{Instagantt}
Questo tool viene affiancato ad \textit{Asana$_{G}$} e permette la costruzione dei \textit{diagrammi di}\glossario{Gantt}con le task che vengono effettivamente create dal gruppo.
\subparagraph{Astah uml}
Questo software serve per la creazione dei diagrammi\glossario{UML}, è possibile scaricarlo al seguente indirizzo \url{http://astah.net/editions/uml-new}.
