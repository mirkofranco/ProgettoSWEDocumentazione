\chapter{Capitolato C3: G\&B}
\section{Descrizione generale}
Nel\glossario{capitolato}C3 si richiede che venga realizzato un plug-in che applichi dei metodi di intelligenza artificiale a flussi di dati e che sia integrabile a \emph{Grafana}.
\section{Finalit\`a del progetto}
L'obbiettivo del\glossario{progetto}è quello di realizzare, usando \emph{Javascript$_{G}$}, un plug-in che dovrà essere in grado di soddisfare i seguenti punti:
\begin{enumerate}
...
\end{itemize}
\section{Conclusione}
Alla prima lettura, il\glossario{capitolato}ha attirato l'attenzione del team ma, dopo un'approfondita riflessione, si è deciso di escluderlo dato che si trattava di lavorare con le \emph{reti Bayesiane}.